...
file=open("buugaag.txt", "w")
file.write("- cinwaan: " +cinwaan)
file.write(" qoraa:" +qoraa)
file.write("sanad: " +sanad)
file.write(" luqad: " +luqad)
file.write("handle: " + handle)
file.write("pdf: " + pdf)
file.write("magaalo: " + magaalo)
file.close()
